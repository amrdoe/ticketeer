    ...
    public function handle(): void
    {
        ...
        for ($i = 0; $i < $slugs->count(); $i++) {
            ...
            try {
                ...
                if (count($images)) $this->table(['Images'], array_map(fn ($i) => [$i], $images));
                ...
                if ($about) $this->line("About: $about");
                ...
                if ($latitude) $this->line("Latitude: $latitude");
                if ($longitude) $this->line("Longitude: $longitude");

                $phoneButton = $crawler->filter("a:has(.icon-call-1)");
                $phone = $phoneButton->count() > 0 ? substr($phoneButton->attr('href'), 4) : "";
                if ($phone) $this->line("Phone: $phone");
                ...
                if ($website) $this->line("Website: $website");
                ...
                if (!$this->option('recursive')) continue;
